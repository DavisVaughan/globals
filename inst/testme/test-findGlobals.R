...
message(" ** findGlobals(..., method = 'tree'):")
expr <- exprs$A
print(expr)
...
globals_t <- findGlobals(fcn, method = "tree")
print(globals_t)
...
globals_t <- findGlobals(x, method = "tree")
print(globals_t)
...
globals_t <- findGlobals(expr, tweak = tweak_another_expression, method = "tree")
print(globals_t)
